...
echo ""
echo -e "${CYAN}  ── Try these once inside NEURO: ──────────────────────────${RESET}"
echo -e "  ${GREEN}▶${RESET} open downloads"
echo -e "  ${GREEN}▶${RESET} find hidden files"
echo -e "  ${GREEN}▶${RESET} find files bigger than 100MB"
echo -e "  ${GREEN}▶${RESET} open brightness settings"
echo -e "  ${GREEN}▶${RESET} set brightness to 70%"
echo -e "  ${GREEN}▶${RESET} open wifi settings"
echo -e "  ${GREEN}▶${RESET} open calculator"
echo -e "  ${GREEN}▶${RESET} open notepad"
echo -e "  ${GREEN}▶${RESET} create a python program to find the sum of two numbers"
echo -e "  ${GREEN}▶${RESET} edit file"
echo -e "  ${GREEN}▶${RESET} regenerate"
echo -e "  ${GREEN}▶${RESET} set brightness to 100% --explain"
echo ""
